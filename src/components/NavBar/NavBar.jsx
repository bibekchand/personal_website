	...
	return (
		<>
			<button
				...
				className="fixed text-blue-950 z-10 right-0 p-10 cursor-pointer"
			>
				Menu
			</button>
			<nav
				className="text-4xl flex justify-center items-center fixed w-full truncate z-9"
				style={{
					height: isButtonClicked ? "100%" : "0",
				}}
			>
